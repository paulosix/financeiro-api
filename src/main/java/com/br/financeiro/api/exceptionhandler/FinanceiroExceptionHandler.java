...
public class FinanceiroExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        List<Erro> erros = Arrays.asList(new Erro[]{new Erro(mensagemUsuario, mensagemDesenvolvedor)});
    ...
    public static class  Erro{
        private String mensagemUsusaio;
        private String mesagemDesenvolvedor;

        public String getMensagemUsusaio() {
            return mensagemUsusaio;
        }
        ...
        public Erro(String mensagemUsusaio, String mesagemDesenvolvedor) {
            this.mensagemUsusaio = mensagemUsusaio;
